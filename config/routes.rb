...
ActionController::Routing::Routes.draw do |map|
  ...
  map.with_options :controller => 'clips', :requirements => { :year => /\d{4}/, :month => /\d{1,2}/, :day => /\d{1,2}/, :article_id => regex_for(:article, :permalink), :user_id => regex_for(:user, :nick) } do |cl|
    # Article clips
  ...
  # Article -> Comments
  map.with_options :controller => 'comments', :requirements  => { :year => /\d{4}/, :month => /\d{1,2}/, :day => /\d{1,2}/, :article_id => regex_for(:article, :permalink), :user_id => regex_for(:user, :nick) } do |cm|
    # Article comments
  ...
  map.with_options :controller => 'permissions', :requirements => { :year => /\d{4}/, :month => /\d{1,2}/, :day => /\d{1,2}/, :article_id => regex_for(:article, :permalink), :user_id => regex_for(:user, :nick), :comment_id => regex_for(:comment, :id) } do |pm|
  ...
  # Article -> Permissions
  map.with_options :controller => 'permissions', :requirements => { :year => /\d{4}/, :month => /\d{1,2}/, :day => /\d{1,2}/, :article_id => regex_for(:article, :permalink), :user_id => regex_for(:user, :nick) } do |pm|
  ...
  # Article -> Pictures
  map.with_options :controller => 'pictures', :requirements => { :year => /\d{4}/, :month => /\d{1,2}/, :day => /\d{1,2}/, :article_id => regex_for(:article, :permalink), :user_id => regex_for(:user, :nick) } do |picture|
  ...
  map.with_options :controller => 'permissions', :requirements => { :year => /\d{4}/, :month => /\d{1,2}/, :day => /\d{1,2}/, :article_id => regex_for(:article, :permalink), :user_id => regex_for(:user, :nick), :picture_id => regex_for(:picture, :id) } do |ap|
