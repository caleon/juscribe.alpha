...
ActionController::Routing::Routes.draw do |map|
  ...
  map.with_options :controller => 'comments', :requirements  => { :year => /\d{4}/, :month => /\d{1,2}/, :day => /\d{1,2}/,
                                                                  :article_id => regex_for(:article, :permalink),
                                                                  :user_id => regex_for(:user, :nick) } do |cm|
    # Article comments
    cm.article_comments ':year/:month/:day/:article_id/by/:user_id/comments', :action => 'index', :conditions => { :method => :get }
    cm.connect ':year/:month/:day/:article_id/by/:user_id/comments', :action => 'create', :conditions => { :method => :post }
    cm.new_article_comment ':year/:month/:day/:article_id/by/:user_id/comments/new', :action => 'new', :conditions => { :method => :get }
    cm.edit_article_comment ':year/:month/:day/:article_id/by/:user_id/comments/:id/edit', :action => 'edit', :conditions => { :method => :get }, :requirements => { :id => regex_for(:comment, :id) }
    cm.article_clip ':year/:month/:day/:article_id/by/:user_id/comments/:id', :action => 'show', :conditions => { :method => :get }, :requirements => { :id => regex_for(:comment, :id) }
    cm.connect ':year/:month/:day/:article_id/by/:user_id/comments/:id', :action => 'update', :conditions => { :method => :put }, :requirements => { :id => regex_for(:comment, :id) }
    cm.connect ':year/:month/:day/:article_id/by/:user_id/comments/:id', :action => 'destroy', :conditions => { :method => :delete }, :requirements => { :id => regex_for(:comment, :id) }
  end
  ...
  map.resources :pictures, :requirements => { :id => regex_for(:picture, :id) } do |picture|
    ...
    picture.resources :comments, :requirements => { :picture_id => regex_for(:comment, :id),
  ...
  map.resources :users,
    ...
    user.resources :entries, :requirements => { :user_id => regex_for(:user, :nick), :id => regex_for(:entry, :id) } do |entry|
      entry.resources :clips, :requirements => { :user_id => regex_for(:user, :nick), :entry_id => regex_for(:entry, :id), :id => regex_for(:clip, :id) }
      entry.resources :comments, :requirements => { :user_id => regex_for(:user, :nick), :entry_id => regex_for(:entry, :id), :id => regex_for(:comment, :id) }
    end
